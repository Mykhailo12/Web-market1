from django.db import models #Base models
...
class Category(models.Model):
    name = models.CharField(max_length=255, verbose_name='Имя категории') #Object name
    slug = models.SlugField(unique = True) #Object slug / id
